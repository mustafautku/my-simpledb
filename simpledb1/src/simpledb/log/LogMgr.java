...
public class LogMgr implements Iterable<BasicLogRecord>{
	...
	private void finalizeRecord(){
		mypage.setInt(currentpos, getLastRecordPosition());//0.log kaydýnda a ve b stringleri eklemiþ 
		//gelmiþ 14.offsete 14 . offsete 0 deðerini yazýyo yani bu stringler 0.logkayda ait setIntte
