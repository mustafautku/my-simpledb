 ...
 */
class ActiveCheckpointFinalize implements LogRecord {

   /**
    * Creates a quiescent checkpoint record.
    */
   public ActiveCheckpointFinalize() {}
    ...
    */
   public ActiveCheckpointFinalize(BasicLogRecord rec) {}
   ...
   public int writeToLog() {
      Object[] rec = new Object[] {ACTIVE_CHECKPOINT_FINALIZE};
      return logMgr.append(rec);
   }

   public int op() {
      return ACTIVE_CHECKPOINT_FINALIZE;
   }
