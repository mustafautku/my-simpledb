...
public class Test1{
	...
	private static void testRollback(){
		...
		buff = bm.pin(blk);
		if(buff.getInt(4) != 9876 || !buff.getString(20).equals("abcdefg"))
	...
	private static void testRecover(){
		...
		// verify that the changes got made
		buff = bm.pin(blk);
		if(buff.getInt(104) != 1234 || !buff.getString(120).equals("xyz") || !buff.getString(140).equals("rst"))
		...
		buff = bm.pin(blk);
		if(buff.getInt(104) != 9999 || !buff.getString(120).equals("xyz") || !buff.getString(140).equals("kjih"))
